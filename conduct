# *DRAFT* - GO FAIR North America Code of Conduct

*See [Jupyter Code of Conduct](https://github.com/jupyter/governance/tree/master/conduct)*

*See [Jupyter Day in the Triangle](https://github.com/libcce/TriangleJupyter/edit/master/conduct.md) example*

GO FAIR North America is an engaged and respectful community made up of people
...
[*email*](mailto:email) or by filling out [this
form](form). For more details please see our
Reporting Guidelines (for [online]() and
[in-person]() contexts).

This code applies equally to founders, developers, mentors and new community
members, in all spaces managed by Go FAIR North America. This
...
[*email*](mailto:email) with any questions.
...
[*email*](mailto:email) or by filing out
[this form](form). For more details or
...
Up!*](http://web.archive.org/web/20141109123859/http://speakup.io/coc.html), [*Django*](https://www.djangoproject.com/conduct) and Jupyter Projects,
